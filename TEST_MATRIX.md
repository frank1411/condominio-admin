...
| PEND-BUG-001 | Pagos parciales | Bug reportado por usuario tras limpiar BD — NO reproducible: re-test limpio con 2 pagos parciales (15 + 10) sobre deuda $40.02 → deuda final $15.02 exacta, ambos aprobados, crédito $0 | — | ✅ NO REPRODUCIDO + RE-TEST ✅ (2026-08-03) | Verificado en BD: apto 002, pagos #3 ($15) y #4 ($10) approved; 40.02 − 15 − 10 = 15.02 |
...
| PAG-07 | Pago parcial (menor a deuda) | Deuda $50, pago $30 | Crear + aprobar | 30 | Deuda pendiente $20, `isPaid=false` | ✅ PASÓ + RE-TEST ✅ (2026-08-03) | Re-test limpio apto 002: pago $15 sobre $40.02 → pendiente $25.02; 2º pago $10 → $15.02. Múltiples pagos parciales/mes válidos (3+3+9) |
...
| COB-03 | Crear cobro con monto 0/negativo | Admin | Monto 0 / -50 | 0, -50 | Rechazado | ✅ RE-TEST ✅ (2026-08-03) | Confirmado por usuario: toast "El monto debe ser un número positivo mayor a cero" en monto 0 y en -5 |
